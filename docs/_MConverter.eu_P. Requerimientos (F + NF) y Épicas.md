...
- **EP-00: Arquitectura Base y Flujos del Sistema**
  ...
  - **HU 0.2:** Modelado y despliegue del esquema de base de datos relacional (PostgreSQL) con soporte espacial (PostGIS).
...
- **EP-02: Core PWA y Experiencia de Usuario Móvil**
  ...
  - **HU 2.1:** Instalación de la aplicación en la pantalla de inicio del móvil (Add to Home Screen).

  - **HU 2.2:** Implementación de estados de carga esqueléticos (Skeleton loaders) y manejo de errores amigables ante pérdida de red. (Reemplaza la antigua HU de navegación offline)
...
- **EP-03: Gestión del Catálogo P2P**
  ...
  - **HU 3.2:** Edición y actualización del estado de inventario de una publicación.
...
- **EP-05: Geolocalización Hiper-Local (Campus UAO)**
  ...
  - **HU 5.1:** Visualización del mapa interactivo del campus (OpenStreetMap) con marcadores de productos.

  - **HU 5.2:** Asignación de ubicación física dentro del campus a una publicación.

  - **HU 5.3:** Filtrado del catálogo por radio de cercanía (metros).
...
- **EP-06: Negociación y Cierre P2P (Frictionless)**
  ...
  - **HU 6.1:** Chat interno en tiempo real entre comprador y vendedor.

  - **HU 6.2:** Integración de Deep Link para facilitar el salto directo de pago hacia Nequi.

  - **HU 6.3:** Integración de Deep Link para facilitar el salto directo de pago hacia DaviPlata.

  - **HU 6.4:** Marcado manual de \"Transacción Completada\" por ambas partes en el chat.
...
- **EP-07: Moderación y Reputación Comunitaria**
  ...
  - **HU 7.2:** Visualización del puntaje promedio de reputación en el perfil del vendedor.

  - **HU 7.3:** Sistema de reporte de publicaciones o usuarios por comportamiento indebido.
...
- **🛍️ EP-03: Gestión del Catálogo P2P**
...
- **⚖️ EP-07: Moderación y Reputación Comunitaria**
