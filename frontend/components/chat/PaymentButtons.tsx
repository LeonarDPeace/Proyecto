...
export default function PaymentButtons({
  ...
  const handlePayment = async (platform: "nequi" | "daviplata") => {
    ...
    try {
      ...
      // Intentar abrir el deep link en el dispositivo
      window.location.href = link.deep_link_url;

      // Fallback: si después de 2s no se abrió la app, mostrar info
      setTimeout(() => {
        setLoading(null);
      }, 2000);
    } catch (err: any) {
    ...
    <div className="payment-buttons">
      ...
      <div className="payment-buttons-row">
        ...
        >
          ...
          {loading === "daviplata" ? "Abriendo…" : "DaviPlata"}
        </button>
      </div>
